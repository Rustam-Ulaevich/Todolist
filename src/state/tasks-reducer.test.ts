...
test('title of task should be changed', () => {
    ...
    debugger
    const endState = tasksReducer(startState, changeTaskTitleAC("todolistId2", "2", 'sold'))

    expect(endState['todolistId2'][1].title).toBe('sold');
    expect(endState['todolistId1'][1].title).toBe('JS');
    expect(startState['todolistId2'][1].title).toBe('sold');
});
